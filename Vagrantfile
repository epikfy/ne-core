...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "NE-CORE" do |machine_id|
      ...
      # NOTE: This will enable public access to the opened port
       ...
       machine_id.vm.network "forwarded_port", guest: 9000, host: 9000
      ...
      # argument is a set of non-required options.
       machine_id.vm.synced_folder ".", "/var/www", type: "smb", smb_username: "Julio" ,smb_password: "1103", :mount_options => ["mfsymlinks,dir_mode=0777,file_mode=0777,vers=3.0"]
       machine_id.vm.synced_folder ".", "/vagrant", type: "smb", smb_username: "Julio" ,smb_password: "1103", :mount_options => ["mfsymlinks,dir_mode=0777,file_mode=0777,vers=3.0"]
